...
public:
    ...
    virtual Aws::String &getSaveDir()  { return m_dir; } // the directory we save into
    virtual Aws::String &getTrackDir() { return m_dir; } // the directory we are tracking
    ...
    void setDir(Aws::String dir) { m_dir = dir; }
